...
export class CreateUserDto {
  ...
  @ApiProperty({example: 'Heder Moreira David', description: 'Nome do usuário' })
  readonly name: string;

  @IsEmail({}, { message: 'O e-mail informado não é válido.' })
  @IsNotEmpty({ message: 'O campo de e-mail não pode ser vazio.' })
  @ApiProperty({example: 'hedermd6@gmail.com', description: 'E-mail do usuário' })
  ...
  @ApiProperty({ example: 'BA', description: 'Estado do usuário' })
  readonly state: string;

  @IsString({ message: 'A cidade deve ser um texto.' })
  @IsNotEmpty({ message: 'O campo de cidade não pode ser vazio.' })
  @ApiProperty({ example: 'Vitória da Conquista', description: 'Cidade do usuário' })
  ...
  @ApiProperty({ example: '(77) 99160-7631', description: 'Telefone do usuário' })
